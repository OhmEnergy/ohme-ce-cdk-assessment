...
export class DevEcsClusterStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const alb = new elbv2.ApplicationLoadBalancer(this, 'ALB', {
            loadBalancerName: `ohme-assessment-dev-alb`,
            internetFacing: true,
            vpc,
        ...
        const asgIamRole = new iam.Role(this, 'ASG-Iam-Role', {
            roleName: 'ohme-assessment-dev-asg-iam-role',
        ...
        const launchTemplate = new ec2.LaunchTemplate(this, 'Launch-Template', {
            launchTemplateName: 'ohme-assessment-dev-launch-template',
        ...
        const asgGroup = new asg.AutoScalingGroup(this, 'ASG', {
            autoScalingGroupName: 'ohme-assessment-dev-asg',
            vpc: vpc,
            vpcSubnets: publicSubnets,
        ...
        const capacityProvider = new ecs.AsgCapacityProvider(
            ...
            'AsgCapacityProvider',
            {
                capacityProviderName: 'ohme-assessment-dev-capacity-provider',
        ...
        const ecsCluster = new ecs.Cluster(this, 'EcsCluster', {
            vpc: vpc,
            clusterName: 'ohme-assessment-dev-ecs-cluster',
        });
